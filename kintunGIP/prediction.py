...
## START
tdnas_df = pd.read_csv("Kae_results/Kae_tDNAs.csv", header=0, index_col=0)
cds_df = pd.read_csv("Kae_results/Kae_core_CDSs.csv", header=0, index_col=0)
core_df = pd.read_csv("Kae_results/Kae_coregenome_detail.csv", header=0, index_col=1)
left_dict, right_dict = check_cds(tdnas_df)
